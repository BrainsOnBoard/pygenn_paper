...
Finally, in this work we have introduced a new spike recording system for GeNN and have shown that, using this system, we can now simulate the Potjans microcircuit~\citep{Potjans2012} model faster than realtime, which thus far was only possible on the large SpiNNaker neuromorphic supercomputer~\citep{Rhodes2019}.
