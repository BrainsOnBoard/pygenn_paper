...
For example, using the \lstinline{SharedLibraryModel} helper class supplied with GeNN, this example loads the previously defined model, initialises the heterogenous neuron parameters and prints each neuron's membrane voltage every timestep: 
%
\begin{lstlisting}[language=C++]
...
\end{lstlisting}
%
This approach is key to how we implement PyGeNN.
