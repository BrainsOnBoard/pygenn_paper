...
\end{lstlisting}
%
We then instruct GeNN to keep track of the times of current and previous pre and postsynaptic spikes.
...
\end{lstlisting}
%
The synaptic weight $w_{ij}$ update described by 
In order to deliver the dopamine 
Because $w_{ij}$
