...
Additional delay slots could be artificially added to the neuron population so that this data structure could be repurposed to store spike data for subsequent recording.
